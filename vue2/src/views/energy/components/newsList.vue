  ...
  <div class="new-list-rank-container">
    <div class="new-list-container">
      ...
      <div class="new-list-enum">
        <div class="new-list-item" v-for="(item, index) in newList" :key="index">
    ...
    <div class="energy-rank">
      <div class="energy-rank-type">
        <div class="energy-rank-title">新能源体验</div>
      ...
      <div class="energy-rank-type">
        <div class="energy-rank-title">新能源销量</div>

        <div class="energy-rank-list">
          <div v-for="(item, index) in rankList" :key="index">
            <span class="energy-rank-number" :class="{ [`energy-rank-number-${index}`]: index <= 2 }">{{
              index + 1
            }}</span>
            <img :src="rankCar" alt="" />
            <div class="energy-rank-content">
              <div>{{ item.name }}</div>
              <div>
                <span>{{ item.number }}台</span> / {{ item.time }}
              </div>
            </div>
          </div>
        </div>
